	...
	$.ajax({
		...
		success: function(data) {
			...
			$('.main').append(
				$('<div>')
				.attr('class','contenu'));
			$('.frame-content').prepend(
				$('<div>')
				.attr('class','ui-bar ui-bar-a')
				.append(
					vaisseau_hangar(listeShip[0])));
				...
				.append(
					...
					.append(
						...
						.click(function() {
							...
							$('.frame-content .ui-bar').fadeOut(500, function() {
								$(this).empty();
								$(this).append(vaisseau_hangar(listeShip[prev]));
								$(this).fadeIn(500);
								currentId = prev;
							});
						...
						.click(function() {
							...
							$('.frame-content .ui-bar').fadeOut(500, function() {
								$(this).empty();
								$(this).append(vaisseau_hangar(listeShip[next]));
								$(this).fadeIn(500);
								currentId = next;
							});
